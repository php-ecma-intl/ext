...
Test(TEST_SUITE, applyLocaleOptionsWillAllPopulatedOptions)
{
	...
	originalLocale = ecma402_initLocale("en-Latn-US-u-ca-buddhist-kf-lower-co-phonebk-hc-h12-nu-arab-kn-cu-eur");
	newLocale = ecma402_applyLocaleOptions(originalLocale, "gregory", "upper", "emoji", "cad", "h23", "fr", "latn",
	                                       false, "CA", "Some");
...
Test(TEST_SUITE, applyLocaleOptionsWithAllNullOptions)
{
	...
	originalLocale = ecma402_initLocale("en-Latn-US-u-ca-buddhist-kf-lower-co-phonebk-hc-h12-nu-arab-kn-cu-eur");
	newLocale = ecma402_applyLocaleOptions(originalLocale, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -1, NULL, NULL);
