...
{
	ecma402_locale *locale = ecma402_initLocale("de-latn-de-u-ca-gregory-co-phonebk-hc-h23-kf-true-kn-true-nu-latn");

	cr_expect(eq(str, locale->baseName, "de-Latn-DE"));
	cr_expect(eq(str, locale->calendar, "gregory"));
	cr_expect(eq(str, locale->canonical, "de-Latn-DE-u-ca-gregory-co-phonebk-hc-h23-kf-kn-nu-latn"));
	...
	cr_expect(eq(str, locale->original, "de-latn-de-u-ca-gregory-co-phonebk-hc-h23-kf-true-kn-true-nu-latn"));
