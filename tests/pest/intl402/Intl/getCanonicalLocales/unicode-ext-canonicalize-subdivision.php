...
it('canonicalizes for the "sd" Unicode subtag extension key', function (
    string $alias,
    string $name,
): void {
    $region = strtoupper(substr($name, 0, 2));
    $tag = "und-$region-u-sd-$alias";
    $canonical = "und-$region-u-sd-$name";
