...
static inline bool setStringPropertyFromStringOrStringable(
    zend_class_entry *ce, zend_object *object, const char *propertyName,
    zend_string *valueString, zend_object *valueStringable,
